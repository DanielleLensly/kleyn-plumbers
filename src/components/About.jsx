      ...
      <div className="container">
        <div className="about-content">
          ...
          <div className="about-text">
            ...
            <p>We believe that quality stems from our commitment to excellence and service.</p>
            <p>As a company, we are committed to the process of continual improvement and the provision of quality, safe and environmentally responsible services and products. We will continue to measure our performance and improve our quality so that our customers can maintain the highest level of confidence in our work.</p>
          </div>
        </div>
      </div>
    </section>
